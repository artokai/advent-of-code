...
{
    public static string Optimize(string program)
    {
    ...
    private static string UseAddInstruction(string program)
    {
    ...
    private static string UseMultiplyInstruction(string program)
    {
